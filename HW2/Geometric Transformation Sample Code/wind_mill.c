...
void draw_floor()
{
  ...
  for(i=0;i<10;i++)
    for(j=0;j<10;j++){
      if((i+j)%2==0) glColor3f(64.0/255, 224.0/255, 208.0/255);
      else glColor3f(224.0/255, 255.0/255, 255/255);
      glBegin(GL_POLYGON);
...
void display()
{
  ...
  glPushMatrix();
    ...
    glPushMatrix();
      ...
      glRotatef(-90.0, 1.0, 0.0, 0.0);
      if(wheel_A_cylinder==NULL){               /* allocate a quadric object, if necessary */
    ...
    glPushMatrix();
      ...
      glTranslatef(0.0,-0.5,leg_len + 0.5);
      glRotatef(-90.0, 1.0, 0.0, 0.0);
      if(wheel_B_cylinder==NULL){               /* allocate a quadric object, if necessary */
    ...
    glPushMatrix();
      ...
      glTranslatef(0.0,-0.5,leg_len + 0.5);
      glRotatef(-90.0, 1.0, 0.0, 0.0);
      if(wheel_C_cylinder==NULL){               /* allocate a quadric object, if necessary */
